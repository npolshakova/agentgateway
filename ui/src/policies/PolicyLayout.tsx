...
export function PolicySection(props: {
	...
	return (
		<section className={props.compact ? 'policy-form-section compact' : 'policy-form-section'}>
...
export function AdvancedSettingRow(props: {
	...
	return (
		<section
			className={
				props.className ? `advanced-setting-row ${props.className}` : 'advanced-setting-row'
			}
		>
...
export function AdvancedSettingPanel(props: {
	...
	return (
		<section
			className={
				props.className ? `advanced-setting-panel ${props.className}` : 'advanced-setting-panel'
			}
		>
