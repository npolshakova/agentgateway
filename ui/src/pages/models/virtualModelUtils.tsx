...
export function modelTargetOptions(models: LlmModel[], providers: LlmProvider[]) {
...
export function isIncompleteWildcardTarget(targetModel: string, baseModels: LlmModel[]) {
...
export function failoverTargetGroups(
	...
	const priorities = [...new Set(targets.map(target => target.priority ?? 0))].sort(
