...
// gosec (via golangci-lint) wants yaml/v4 rc.6, whose reworked error API drops
// yaml.ParserError and the fields actionlint reads off TypeError. actionlint has
// no release or main-branch commit that builds against rc.6 yet, so hold rc.3
// until it does.
