...
func allEnvVarsSet() map[string]string {
	return map[string]string{
		...
		"AGW_DEFAULT_IMAGE_REGISTRY":                   "custom-registry.io",
		"AGW_DEFAULT_IMAGE_TAG":                        "v1.0.0",
		"AGW_DEFAULT_IMAGE_PULL_POLICY":                "Always",
		"AGW_LOG_LEVEL":                                "debug",
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedSettings: &Settings{
				...
				DefaultImageRegistry:                 "cr.agentgateway.dev",
				DefaultImageTag:                      "",
		...
		},
		{
			...
			expectedSettings: &Settings{
				...
				EnableInferExt:                       true,
				DefaultImageRegistry:                 "custom-registry.io",
