...
var (
	translationTime      = stats.Float64("io.agentgateway/translation_time_sec", "how long the translator takes in seconds", "s")
...
func init() {
	...
	if err := view.Register(
		&view.View{
			Name:        "io.agentgateway/translation_time_sec",
