...
type Route struct {
	...
	InlinePolicies []*TrafficPolicySpec `protobuf:"bytes,10,rep,name=inline_policies,json=inlinePolicies,proto3" json:"inline_policies,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Route) GetInlinePolicies() []*TrafficPolicySpec {
	if x != nil {
...
type RouteFilter_RequestMirror struct {
	RequestMirror *RequestMirror `protobuf:"bytes,1,opt,name=request_mirror,json=requestMirror,proto3,oneof"`
}

type RouteFilter_RequestRedirect struct {
	RequestRedirect *RequestRedirect `protobuf:"bytes,2,opt,name=request_redirect,json=requestRedirect,proto3,oneof"`
}

type RouteFilter_UrlRewrite struct {
	UrlRewrite *UrlRewrite `protobuf:"bytes,3,opt,name=url_rewrite,json=urlRewrite,proto3,oneof"`
}

type RouteFilter_DirectResponse struct {
	DirectResponse *DirectResponse `protobuf:"bytes,4,opt,name=direct_response,json=directResponse,proto3,oneof"`
}
...
type BackendPolicySpec struct {
	...
	//	*BackendPolicySpec_McpAuthorization
...
func (x *BackendPolicySpec) GetMcpAuthorization() *RBAC {
	if x != nil {
		if x, ok := x.Kind.(*BackendPolicySpec_McpAuthorization); ok {
...
type BackendPolicySpec_McpAuthorization struct {
	McpAuthorization *RBAC `protobuf:"bytes,5,opt,name=mcp_authorization,json=mcpAuthorization,proto3,oneof"`
}

type BackendPolicySpec_Ai_ struct {
	Ai *BackendPolicySpec_Ai `protobuf:"bytes,6,opt,name=ai,proto3,oneof"`
}
...
func (*BackendPolicySpec_McpAuthorization) isBackendPolicySpec_Kind() {}
...
type TrafficPolicySpec struct {
	...
	//	*TrafficPolicySpec_McpAuthorization
...
func (x *TrafficPolicySpec) GetMcpAuthorization() *RBAC {
	if x != nil {
		if x, ok := x.Kind.(*TrafficPolicySpec_McpAuthorization); ok {
			return x.McpAuthorization
		}
	}
	return nil
...
type TrafficPolicySpec_LocalRateLimit_ struct {
	LocalRateLimit *TrafficPolicySpec_LocalRateLimit `protobuf:"bytes,1,opt,name=local_rate_limit,json=localRateLimit,proto3,oneof"`
}

type TrafficPolicySpec_ExtAuthz struct {
	ExtAuthz *TrafficPolicySpec_ExternalAuth `protobuf:"bytes,2,opt,name=ext_authz,json=extAuthz,proto3,oneof"`
}

type TrafficPolicySpec_McpAuthorization struct {
	McpAuthorization *RBAC `protobuf:"bytes,3,opt,name=mcp_authorization,json=mcpAuthorization,proto3,oneof"`
}

type TrafficPolicySpec_Jwt struct {
	Jwt *TrafficPolicySpec_JWT `protobuf:"bytes,4,opt,name=jwt,proto3,oneof"`
}

type TrafficPolicySpec_Transformation struct {
	Transformation *TrafficPolicySpec_TransformationPolicy `protobuf:"bytes,5,opt,name=transformation,proto3,oneof"`
}

type TrafficPolicySpec_RemoteRateLimit_ struct {
	RemoteRateLimit *TrafficPolicySpec_RemoteRateLimit `protobuf:"bytes,6,opt,name=remote_rate_limit,json=remoteRateLimit,proto3,oneof"`
}

type TrafficPolicySpec_Csrf struct {
	Csrf *TrafficPolicySpec_CSRF `protobuf:"bytes,7,opt,name=csrf,proto3,oneof"`
}

type TrafficPolicySpec_ExtProc_ struct {
	ExtProc *TrafficPolicySpec_ExtProc `protobuf:"bytes,8,opt,name=ext_proc,json=extProc,proto3,oneof"`
}

type TrafficPolicySpec_RequestHeaderModifier struct {
	RequestHeaderModifier *HeaderModifier `protobuf:"bytes,9,opt,name=request_header_modifier,json=requestHeaderModifier,proto3,oneof"`
}

type TrafficPolicySpec_ResponseHeaderModifier struct {
	ResponseHeaderModifier *HeaderModifier `protobuf:"bytes,10,opt,name=response_header_modifier,json=responseHeaderModifier,proto3,oneof"`
}

type TrafficPolicySpec_Cors struct {
	Cors *CORS `protobuf:"bytes,11,opt,name=cors,proto3,oneof"`
}
...
func (*TrafficPolicySpec_McpAuthorization) isTrafficPolicySpec_Kind() {}
...
type Policy_Traffic struct {
	Traffic *TrafficPolicySpec `protobuf:"bytes,3,opt,name=traffic,proto3,oneof"`
}

type Policy_Backend struct {
	Backend *BackendPolicySpec `protobuf:"bytes,4,opt,name=backend,proto3,oneof"`
}

type Policy_Frontend struct {
	Frontend *FrontendPolicySpec `protobuf:"bytes,5,opt,name=frontend,proto3,oneof"`
}
...
func (*TrafficPolicySpec_TransformationPolicy_Transform) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{39, 4, 0}
}
...
const file_resource_proto_rawDesc = "" +
	...
	"\x0etraffic_policy\x18\t \x01(\v2(.agentgateway.dev.resource.TrafficPolicyR\rtrafficPolicy\x12U\n" +
	"\x0finline_policies\x18\n" +
	" \x03(\v2,.agentgateway.dev.resource.TrafficPolicySpecR\x0einlinePolicies\"\xde\x01\n" +
	"\bTCPRoute\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12!\n" +
	"\flistener_key\x18\x02 \x01(\tR\vlistenerKey\x12\x1b\n" +
	"\trule_name\x18\x03 \x01(\tR\bruleName\x12\x1d\n" +
	...
	"\x05value\"\xe1\x02\n" +
	"\vRouteFilter\x12Q\n" +
	"\x0erequest_mirror\x18\x01 \x01(\v2(.agentgateway.dev.resource.RequestMirrorH\x00R\rrequestMirror\x12W\n" +
	"\x10request_redirect\x18\x02 \x01(\v2*.agentgateway.dev.resource.RequestRedirectH\x00R\x0frequestRedirect\x12H\n" +
	"\vurl_rewrite\x18\x03 \x01(\v2%.agentgateway.dev.resource.UrlRewriteH\x00R\n" +
	"urlRewrite\x12T\n" +
	"\x0fdirect_response\x18\x04 \x01(\v2).agentgateway.dev.resource.DirectResponseH\x00R\x0edirectResponseB\x06\n" +
	"\x04kind\"\xfd\x01\n" +
	"\x04CORS\x12+\n" +
	...
	"\x04deny\x18\x02 \x03(\tR\x04deny\"\xac\x1e\n" +
	...
	"backendTls\x12B\n" +
	"\x04auth\x18\x04 \x01(\v2,.agentgateway.dev.resource.BackendAuthPolicyH\x00R\x04auth\x12N\n" +
	"\x11mcp_authorization\x18\x05 \x01(\v2\x1f.agentgateway.dev.resource.RBACH\x00R\x10mcpAuthorization\x12A\n" +
	"\x02ai\x18\x06 \x01(\v2/.agentgateway.dev.resource.BackendPolicySpec.AiH\x00R\x02ai\x1a\xf9\x15\n" +
	"\x02Ai\x12^\n" +
	...
	"\bhostname\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\bhostnameB\x06\n" +
	"\x04kind\"\x14\n" +
	"\x12FrontendPolicySpec\"\xd7\x1d\n" +
	"\x11TrafficPolicySpec\x12g\n" +
	"\x10local_rate_limit\x18\x01 \x01(\v2;.agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimitH\x00R\x0elocalRateLimit\x12X\n" +
	"\text_authz\x18\x02 \x01(\v29.agentgateway.dev.resource.TrafficPolicySpec.ExternalAuthH\x00R\bextAuthz\x12N\n" +
	"\x11mcp_authorization\x18\x03 \x01(\v2\x1f.agentgateway.dev.resource.RBACH\x00R\x10mcpAuthorization\x12D\n" +
	"\x03jwt\x18\x04 \x01(\v20.agentgateway.dev.resource.TrafficPolicySpec.JWTH\x00R\x03jwt\x12k\n" +
	"\x0etransformation\x18\x05 \x01(\v2A.agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicyH\x00R\x0etransformation\x12j\n" +
	"\x11remote_rate_limit\x18\x06 \x01(\v2<.agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimitH\x00R\x0fremoteRateLimit\x12G\n" +
	"\x04csrf\x18\a \x01(\v21.agentgateway.dev.resource.TrafficPolicySpec.CSRFH\x00R\x04csrf\x12Q\n" +
	"\bext_proc\x18\b \x01(\v24.agentgateway.dev.resource.TrafficPolicySpec.ExtProcH\x00R\aextProc\x12c\n" +
	"\x17request_header_modifier\x18\t \x01(\v2).agentgateway.dev.resource.HeaderModifierH\x00R\x15requestHeaderModifier\x12e\n" +
	"\x18response_header_modifier\x18\n" +
	" \x01(\v2).agentgateway.dev.resource.HeaderModifierH\x00R\x16responseHeaderModifier\x125\n" +
	"\x04cors\x18\v \x01(\v2\x1f.agentgateway.dev.resource.CORSH\x00R\x04cors\x1a\xf0\x03\n" +
	...
	"\x10DENY_WITH_STATUS\x10\x02\x1a\xe1\x01\n" +
	"\x03JWT\x12I\n" +
	...
	"\atraffic\x18\x03 \x01(\v2,.agentgateway.dev.resource.TrafficPolicySpecH\x00R\atraffic\x12H\n" +
	"\abackend\x18\x04 \x01(\v2,.agentgateway.dev.resource.BackendPolicySpecH\x00R\abackend\x12K\n" +
	"\bfrontend\x18\x05 \x01(\v2-.agentgateway.dev.resource.FrontendPolicySpecH\x00R\bfrontendB\x06\n" +
	"\x04kind\"\xdc\x01\n" +
	"\aBackend\x12\x12\n" +
...
var file_resource_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 90)
var file_resource_proto_goTypes = []any{
	(Protocol)(0), // 0: agentgateway.dev.resource.Protocol
	(BackendPolicySpec_Ai_BuiltinRegexRule)(0),          // 1: agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	(BackendPolicySpec_Ai_ActionKind)(0),                // 2: agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	(BackendPolicySpec_InferenceRouting_FailureMode)(0), // 3: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	...
	(AIBackend_RouteType)(0),                            // 9: agentgateway.dev.resource.AIBackend.RouteType
	(MCPBackend_StatefulMode)(0),                        // 10: agentgateway.dev.resource.MCPBackend.StatefulMode
	(MCPBackend_PrefixMode)(0),                          // 11: agentgateway.dev.resource.MCPBackend.PrefixMode
	(MCPTarget_Protocol)(0),                             // 12: agentgateway.dev.resource.MCPTarget.Protocol
	(*Resource)(nil),                                    // 13: agentgateway.dev.resource.Resource
	(*Bind)(nil),                                        // 14: agentgateway.dev.resource.Bind
	(*Listener)(nil),                                    // 15: agentgateway.dev.resource.Listener
	(*TLSConfig)(nil),                                   // 16: agentgateway.dev.resource.TLSConfig
	(*Route)(nil),                                       // 17: agentgateway.dev.resource.Route
	(*TCPRoute)(nil),                                    // 18: agentgateway.dev.resource.TCPRoute
	(*TrafficPolicy)(nil),                               // 19: agentgateway.dev.resource.TrafficPolicy
	...
	(*RouteFilter)(nil),                                 // 39: agentgateway.dev.resource.RouteFilter
	...
	(*RBAC)(nil),                                        // 49: agentgateway.dev.resource.RBAC
	...
	(*StaticBackend)(nil),                               // 55: agentgateway.dev.resource.StaticBackend
	(*AIBackend)(nil),                                   // 56: agentgateway.dev.resource.AIBackend
	(*MCPBackend)(nil),                                  // 57: agentgateway.dev.resource.MCPBackend
	(*MCPTarget)(nil),                                   // 58: agentgateway.dev.resource.MCPTarget
	(*BackendReference)(nil),                            // 59: agentgateway.dev.resource.BackendReference
	(*AzureManagedIdentityCredential_UserAssignedIdentity)(nil), // 60: agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	(*BackendPolicySpec_Ai)(nil),                                // 61: agentgateway.dev.resource.BackendPolicySpec.Ai
	(*BackendPolicySpec_A2A)(nil),                               // 62: agentgateway.dev.resource.BackendPolicySpec.A2a
	(*BackendPolicySpec_InferenceRouting)(nil),                  // 63: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	(*BackendPolicySpec_BackendTLS)(nil),                        // 64: agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	(*BackendPolicySpec_Ai_Message)(nil),                        // 65: agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	(*BackendPolicySpec_Ai_PromptEnrichment)(nil),               // 66: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	(*BackendPolicySpec_Ai_NamedRegex)(nil),                     // 67: agentgateway.dev.resource.BackendPolicySpec.Ai.NamedRegex
	(*BackendPolicySpec_Ai_RegexRule)(nil),                      // 68: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	(*BackendPolicySpec_Ai_Action)(nil),                         // 69: agentgateway.dev.resource.BackendPolicySpec.Ai.Action
	(*BackendPolicySpec_Ai_RegexRules)(nil),                     // 70: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	(*BackendPolicySpec_Ai_Webhook)(nil),                        // 71: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	(*BackendPolicySpec_Ai_Moderation)(nil),                     // 72: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	(*BackendPolicySpec_Ai_RequestRejection)(nil),               // 73: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	(*BackendPolicySpec_Ai_ResponseGuard)(nil),                  // 74: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	(*BackendPolicySpec_Ai_RequestGuard)(nil),                   // 75: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	(*BackendPolicySpec_Ai_PromptGuard)(nil),                    // 76: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	nil,                                                         // 77: agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	nil,                                                         // 78: agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	nil,                                                         // 79: agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	(*TrafficPolicySpec_RemoteRateLimit)(nil),                   // 80: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	(*TrafficPolicySpec_LocalRateLimit)(nil),                    // 81: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	(*TrafficPolicySpec_ExternalAuth)(nil),                      // 82: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	(*TrafficPolicySpec_JWT)(nil),                               // 83: agentgateway.dev.resource.TrafficPolicySpec.JWT
	(*TrafficPolicySpec_TransformationPolicy)(nil),              // 84: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	(*TrafficPolicySpec_HeaderTransformation)(nil),              // 85: agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	(*TrafficPolicySpec_BodyTransformation)(nil),                // 86: agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	(*TrafficPolicySpec_CSRF)(nil),                              // 87: agentgateway.dev.resource.TrafficPolicySpec.CSRF
	(*TrafficPolicySpec_ExtProc)(nil),                           // 88: agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	(*TrafficPolicySpec_RemoteRateLimit_Descriptor)(nil),        // 89: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor
	(*TrafficPolicySpec_RemoteRateLimit_Entry)(nil),             // 90: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	(*TrafficPolicySpec_ExternalAuth_BodyOptions)(nil),          // 91: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.BodyOptions
	nil, // 92: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.ContextEntry
	...
	(*AIBackend_HostOverride)(nil),                           // 94: agentgateway.dev.resource.AIBackend.HostOverride
	(*AIBackend_OpenAI)(nil),                                 // 95: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),                                 // 96: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),                                 // 97: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),                              // 98: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),                                // 99: agentgateway.dev.resource.AIBackend.Bedrock
	(*AIBackend_Provider)(nil),                               // 100: agentgateway.dev.resource.AIBackend.Provider
	(*AIBackend_ProviderGroup)(nil),                          // 101: agentgateway.dev.resource.AIBackend.ProviderGroup
	nil,                                                      // 102: agentgateway.dev.resource.AIBackend.Provider.RoutesEntry
	(*duration.Duration)(nil),                                // 103: google.protobuf.Duration
	(*wrappers.BytesValue)(nil),                              // 104: google.protobuf.BytesValue
	(*wrappers.BoolValue)(nil),                               // 105: google.protobuf.BoolValue
	(*wrappers.StringValue)(nil),                             // 106: google.protobuf.StringValue
	(*wrappers.UInt32Value)(nil),                             // 107: google.protobuf.UInt32Value
}
var file_resource_proto_depIdxs = []int32{
	14,  // 0: agentgateway.dev.resource.Resource.bind:type_name -> agentgateway.dev.resource.Bind
	15,  // 1: agentgateway.dev.resource.Resource.listener:type_name -> agentgateway.dev.resource.Listener
	17,  // 2: agentgateway.dev.resource.Resource.route:type_name -> agentgateway.dev.resource.Route
	...
	18,  // 5: agentgateway.dev.resource.Resource.tcp_route:type_name -> agentgateway.dev.resource.TCPRoute
	0,   // 6: agentgateway.dev.resource.Listener.protocol:type_name -> agentgateway.dev.resource.Protocol
	16,  // 7: agentgateway.dev.resource.Listener.tls:type_name -> agentgateway.dev.resource.TLSConfig
	34,  // 8: agentgateway.dev.resource.Route.matches:type_name -> agentgateway.dev.resource.RouteMatch
	39,  // 9: agentgateway.dev.resource.Route.filters:type_name -> agentgateway.dev.resource.RouteFilter
	47,  // 10: agentgateway.dev.resource.Route.backends:type_name -> agentgateway.dev.resource.RouteBackend
	19,  // 11: agentgateway.dev.resource.Route.traffic_policy:type_name -> agentgateway.dev.resource.TrafficPolicy
	52,  // 12: agentgateway.dev.resource.Route.inline_policies:type_name -> agentgateway.dev.resource.TrafficPolicySpec
	47,  // 13: agentgateway.dev.resource.TCPRoute.backends:type_name -> agentgateway.dev.resource.RouteBackend
	103, // 14: agentgateway.dev.resource.TrafficPolicy.backend_request_timeout:type_name -> google.protobuf.Duration
	103, // 15: agentgateway.dev.resource.TrafficPolicy.request_timeout:type_name -> google.protobuf.Duration
	20,  // 16: agentgateway.dev.resource.TrafficPolicy.retry:type_name -> agentgateway.dev.resource.Retry
	103, // 17: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	22,  // 18: agentgateway.dev.resource.BackendAuthPolicy.passthrough:type_name -> agentgateway.dev.resource.Passthrough
	23,  // 19: agentgateway.dev.resource.BackendAuthPolicy.key:type_name -> agentgateway.dev.resource.Key
	24,  // 20: agentgateway.dev.resource.BackendAuthPolicy.gcp:type_name -> agentgateway.dev.resource.Gcp
	25,  // 21: agentgateway.dev.resource.BackendAuthPolicy.aws:type_name -> agentgateway.dev.resource.Aws
	26,  // 22: agentgateway.dev.resource.BackendAuthPolicy.azure:type_name -> agentgateway.dev.resource.Azure
	27,  // 23: agentgateway.dev.resource.Aws.explicit_config:type_name -> agentgateway.dev.resource.AwsExplicitConfig
	28,  // 24: agentgateway.dev.resource.Aws.implicit:type_name -> agentgateway.dev.resource.AwsImplicit
	29,  // 25: agentgateway.dev.resource.Azure.explicit_config:type_name -> agentgateway.dev.resource.AzureExplicitConfig
	33,  // 26: agentgateway.dev.resource.Azure.developer_implicit:type_name -> agentgateway.dev.resource.AzureDeveloperImplicit
	30,  // 27: agentgateway.dev.resource.AzureExplicitConfig.client_secret:type_name -> agentgateway.dev.resource.AzureClientSecret
	31,  // 28: agentgateway.dev.resource.AzureExplicitConfig.managed_identity_credential:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential
	32,  // 29: agentgateway.dev.resource.AzureExplicitConfig.workload_identity_credential:type_name -> agentgateway.dev.resource.AzureWorkloadIdentityCredential
	60,  // 30: agentgateway.dev.resource.AzureManagedIdentityCredential.user_assigned_identity:type_name -> agentgateway.dev.resource.AzureManagedIdentityCredential.UserAssignedIdentity
	35,  // 31: agentgateway.dev.resource.RouteMatch.path:type_name -> agentgateway.dev.resource.PathMatch
	38,  // 32: agentgateway.dev.resource.RouteMatch.headers:type_name -> agentgateway.dev.resource.HeaderMatch
	37,  // 33: agentgateway.dev.resource.RouteMatch.method:type_name -> agentgateway.dev.resource.MethodMatch
	36,  // 34: agentgateway.dev.resource.RouteMatch.query_params:type_name -> agentgateway.dev.resource.QueryMatch
	43,  // 35: agentgateway.dev.resource.RouteFilter.request_mirror:type_name -> agentgateway.dev.resource.RequestMirror
	44,  // 36: agentgateway.dev.resource.RouteFilter.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	45,  // 37: agentgateway.dev.resource.RouteFilter.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	41,  // 38: agentgateway.dev.resource.RouteFilter.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	103, // 39: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	46,  // 40: agentgateway.dev.resource.HeaderModifier.add:type_name -> agentgateway.dev.resource.Header
	46,  // 41: agentgateway.dev.resource.HeaderModifier.set:type_name -> agentgateway.dev.resource.Header
	59,  // 42: agentgateway.dev.resource.RequestMirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	59,  // 43: agentgateway.dev.resource.RouteBackend.backend:type_name -> agentgateway.dev.resource.BackendReference
	39,  // 44: agentgateway.dev.resource.RouteBackend.filters:type_name -> agentgateway.dev.resource.RouteFilter
	62,  // 45: agentgateway.dev.resource.BackendPolicySpec.a2a:type_name -> agentgateway.dev.resource.BackendPolicySpec.A2a
	63,  // 46: agentgateway.dev.resource.BackendPolicySpec.inference_routing:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	64,  // 47: agentgateway.dev.resource.BackendPolicySpec.backend_tls:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	21,  // 48: agentgateway.dev.resource.BackendPolicySpec.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	49,  // 49: agentgateway.dev.resource.BackendPolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.RBAC
	61,  // 50: agentgateway.dev.resource.BackendPolicySpec.ai:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai
	81,  // 51: agentgateway.dev.resource.TrafficPolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	82,  // 52: agentgateway.dev.resource.TrafficPolicySpec.ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	49,  // 53: agentgateway.dev.resource.TrafficPolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.RBAC
	83,  // 54: agentgateway.dev.resource.TrafficPolicySpec.jwt:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT
	84,  // 55: agentgateway.dev.resource.TrafficPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	80,  // 56: agentgateway.dev.resource.TrafficPolicySpec.remote_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	87,  // 57: agentgateway.dev.resource.TrafficPolicySpec.csrf:type_name -> agentgateway.dev.resource.TrafficPolicySpec.CSRF
	88,  // 58: agentgateway.dev.resource.TrafficPolicySpec.ext_proc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	42,  // 59: agentgateway.dev.resource.TrafficPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	42,  // 60: agentgateway.dev.resource.TrafficPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	40,  // 61: agentgateway.dev.resource.TrafficPolicySpec.cors:type_name -> agentgateway.dev.resource.CORS
	48,  // 62: agentgateway.dev.resource.Policy.target:type_name -> agentgateway.dev.resource.PolicyTarget
	52,  // 63: agentgateway.dev.resource.Policy.traffic:type_name -> agentgateway.dev.resource.TrafficPolicySpec
	50,  // 64: agentgateway.dev.resource.Policy.backend:type_name -> agentgateway.dev.resource.BackendPolicySpec
	51,  // 65: agentgateway.dev.resource.Policy.frontend:type_name -> agentgateway.dev.resource.FrontendPolicySpec
	55,  // 66: agentgateway.dev.resource.Backend.static:type_name -> agentgateway.dev.resource.StaticBackend
	56,  // 67: agentgateway.dev.resource.Backend.ai:type_name -> agentgateway.dev.resource.AIBackend
	57,  // 68: agentgateway.dev.resource.Backend.mcp:type_name -> agentgateway.dev.resource.MCPBackend
	101, // 69: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	58,  // 70: agentgateway.dev.resource.MCPBackend.targets:type_name -> agentgateway.dev.resource.MCPTarget
	10,  // 71: agentgateway.dev.resource.MCPBackend.stateful_mode:type_name -> agentgateway.dev.resource.MCPBackend.StatefulMode
	11,  // 72: agentgateway.dev.resource.MCPBackend.prefix_mode:type_name -> agentgateway.dev.resource.MCPBackend.PrefixMode
	59,  // 73: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	12,  // 74: agentgateway.dev.resource.MCPTarget.protocol:type_name -> agentgateway.dev.resource.MCPTarget.Protocol
	76,  // 75: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	77,  // 76: agentgateway.dev.resource.BackendPolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	78,  // 77: agentgateway.dev.resource.BackendPolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	66,  // 78: agentgateway.dev.resource.BackendPolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	79,  // 79: agentgateway.dev.resource.BackendPolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	59,  // 80: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	3,   // 81: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	104, // 82: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.cert:type_name -> google.protobuf.BytesValue
	104, // 83: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.key:type_name -> google.protobuf.BytesValue
	104, // 84: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.root:type_name -> google.protobuf.BytesValue
	105, // 85: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.insecure:type_name -> google.protobuf.BoolValue
	106, // 86: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.hostname:type_name -> google.protobuf.StringValue
	65,  // 87: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	65,  // 88: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	1,   // 89: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	67,  // 90: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.NamedRegex
	2,   // 91: agentgateway.dev.resource.BackendPolicySpec.Ai.Action.kind:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	73,  // 92: agentgateway.dev.resource.BackendPolicySpec.Ai.Action.reject_response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	69,  // 93: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Action
	68,  // 94: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	38,  // 95: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	106, // 96: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.model:type_name -> google.protobuf.StringValue
	21,  // 97: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	70,  // 98: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	71,  // 99: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	73,  // 100: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	70,  // 101: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	71,  // 102: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	72,  // 103: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	75,  // 104: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	74,  // 105: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	89,  // 106: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.descriptors:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor
	59,  // 107: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	103, // 108: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	5,   // 109: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.Type
	59,  // 110: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	92,  // 111: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.ContextEntry
	6,   // 112: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.FailureMode
	91,  // 113: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.include_request_body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.BodyOptions
	103, // 114: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	107, // 115: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.status_on_error:type_name -> google.protobuf.UInt32Value
	7,   // 116: agentgateway.dev.resource.TrafficPolicySpec.JWT.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT.Mode
	93,  // 117: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	93,  // 118: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	59,  // 119: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	8,   // 120: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.FailureMode
	90,  // 121: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	4,   // 122: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Type
	85,  // 123: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	85,  // 124: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	86,  // 125: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	106, // 126: agentgateway.dev.resource.AIBackend.OpenAI.model:type_name -> google.protobuf.StringValue
	106, // 127: agentgateway.dev.resource.AIBackend.Gemini.model:type_name -> google.protobuf.StringValue
	106, // 128: agentgateway.dev.resource.AIBackend.Vertex.model:type_name -> google.protobuf.StringValue
	106, // 129: agentgateway.dev.resource.AIBackend.Anthropic.model:type_name -> google.protobuf.StringValue
	106, // 130: agentgateway.dev.resource.AIBackend.Bedrock.model:type_name -> google.protobuf.StringValue
	106, // 131: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_identifier:type_name -> google.protobuf.StringValue
	106, // 132: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_version:type_name -> google.protobuf.StringValue
	94,  // 133: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	106, // 134: agentgateway.dev.resource.AIBackend.Provider.path_override:type_name -> google.protobuf.StringValue
	95,  // 135: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	96,  // 136: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	97,  // 137: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	98,  // 138: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	99,  // 139: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	102, // 140: agentgateway.dev.resource.AIBackend.Provider.routes:type_name -> agentgateway.dev.resource.AIBackend.Provider.RoutesEntry
	100, // 141: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
	9,   // 142: agentgateway.dev.resource.AIBackend.Provider.RoutesEntry.value:type_name -> agentgateway.dev.resource.AIBackend.RouteType
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[37].OneofWrappers = []any{
		...
		(*BackendPolicySpec_McpAuthorization)(nil),
	...
	file_resource_proto_msgTypes[39].OneofWrappers = []any{
		...
		(*TrafficPolicySpec_McpAuthorization)(nil),
