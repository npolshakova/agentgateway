...
type PolicySpec_McpIDP int32

const (
	PolicySpec_AUTH0    PolicySpec_McpIDP = 0
	PolicySpec_KEYCLOAK PolicySpec_McpIDP = 1
)

// Enum value maps for PolicySpec_McpIDP.
var (
	PolicySpec_McpIDP_name = map[int32]string{
		0: "AUTH0",
		1: "KEYCLOAK",
	}
	PolicySpec_McpIDP_value = map[string]int32{
		"AUTH0":    0,
		"KEYCLOAK": 1,
	}
)

func (x PolicySpec_McpIDP) Enum() *PolicySpec_McpIDP {
	p := new(PolicySpec_McpIDP)
	*p = x
	return p
}

func (x PolicySpec_McpIDP) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PolicySpec_McpIDP) Descriptor() protoreflect.EnumDescriptor {
	return file_resource_proto_enumTypes[1].Descriptor()
}

func (PolicySpec_McpIDP) Type() protoreflect.EnumType {
	return &file_resource_proto_enumTypes[1]
}

func (x PolicySpec_McpIDP) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PolicySpec_McpIDP.Descriptor instead.
func (PolicySpec_McpIDP) EnumDescriptor() ([]byte, []int) {
...
func (x *PolicySpec) GetMcpAuthentication() *PolicySpec_MCPAuth {
	if x != nil {
		if x, ok := x.Kind.(*PolicySpec_McpAuthentication); ok {
...
type PolicySpec_McpAuthentication struct {
	McpAuthentication *PolicySpec_MCPAuth `protobuf:"bytes,15,opt,name=mcp_authentication,json=mcpAuthentication,proto3,oneof"`
}
...
func (*PolicySpec_McpAuthentication) isPolicySpec_Kind() {}
...
type PolicySpec_MCPAuth struct {
	state            protoimpl.MessageState       `protogen:"open.v1"`
	...
	Provider         *PolicySpec_McpIDP           `protobuf:"varint,4,opt,name=provider,proto3,enum=agentgateway.dev.resource.PolicySpec_McpIDP,oneof" json:"provider,omitempty"`
	ResourceMetadata *PolicySpec_ResourceMetadata `protobuf:"bytes,5,opt,name=resource_metadata,json=resourceMetadata,proto3" json:"resource_metadata,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *PolicySpec_MCPAuth) Reset() {
	*x = PolicySpec_MCPAuth{}
	mi := &file_resource_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PolicySpec_MCPAuth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolicySpec_MCPAuth) ProtoMessage() {}

func (x *PolicySpec_MCPAuth) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolicySpec_MCPAuth.ProtoReflect.Descriptor instead.
func (*PolicySpec_MCPAuth) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{36, 14}
}

func (x *PolicySpec_MCPAuth) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
func (x *PolicySpec_MCPAuth) GetAudience() string {
	if x != nil {
		return x.Audience
	}
	return ""
...
func (x *PolicySpec_MCPAuth) GetJwksUrl() string {
...
func (x *PolicySpec_MCPAuth) GetProvider() PolicySpec_McpIDP {
	if x != nil && x.Provider != nil {
		return *x.Provider
	}
	return PolicySpec_AUTH0
}

func (x *PolicySpec_MCPAuth) GetResourceMetadata() *PolicySpec_ResourceMetadata {
	if x != nil {
...
type PolicySpec_ResourceMetadata struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
...
func (x *PolicySpec_ResourceMetadata) Reset() {
	*x = PolicySpec_ResourceMetadata{}
	mi := &file_resource_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PolicySpec_ResourceMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PolicySpec_ResourceMetadata) ProtoMessage() {}

func (x *PolicySpec_ResourceMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PolicySpec_ResourceMetadata.ProtoReflect.Descriptor instead.
func (*PolicySpec_ResourceMetadata) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{36, 15}
}

func (x *PolicySpec_ResourceMetadata) GetExtra() map[string]*structpb.Value {
	if x != nil {
		return x.Extra
	}
	return nil
...
const file_resource_proto_rawDesc = "" +
	...
	"\bext_proc\x18\x0e \x01(\v2-.agentgateway.dev.resource.PolicySpec.ExtProcH\x00R\aextProc\x12^\n" +
	"\x12mcp_authentication\x18\x0f \x01(\v2-.agentgateway.dev.resource.PolicySpec.MCPAuthH\x00R\x11mcpAuthentication\x1a\xdb\x03\n" +
	...
	"\tFAIL_OPEN\x10\x01\x1a\xab\x02\n" +
	"\aMCPAuth\x12\x16\n" +
	"\x06issuer\x18\x01 \x01(\tR\x06issuer\x12\x1a\n" +
	"\baudience\x18\x02 \x01(\tR\baudience\x12\x1e\n" +
	"\bjwks_url\x18\x03 \x01(\tH\x00R\ajwksUrl\x88\x01\x01\x12M\n" +
	"\bprovider\x18\x04 \x01(\x0e2,.agentgateway.dev.resource.PolicySpec.McpIDPH\x01R\bprovider\x88\x01\x01\x12c\n" +
	"\x11resource_metadata\x18\x05 \x01(\v26.agentgateway.dev.resource.PolicySpec.ResourceMetadataR\x10resourceMetadataB\v\n" +
	"\t_jwks_urlB\v\n" +
	"\t_provider\x1a\xbd\x01\n" +
	"\x10ResourceMetadata\x12W\n" +
	"\x05extra\x18\x01 \x03(\v2A.agentgateway.dev.resource.PolicySpec.ResourceMetadata.ExtraEntryR\x05extra\x1aP\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 91)
var file_resource_proto_goTypes = []any{
	(Protocol)(0),                                // 0: agentgateway.dev.resource.Protocol
	(PolicySpec_McpIDP)(0),                       // 1: agentgateway.dev.resource.PolicySpec.McpIDP
	(PolicySpec_RemoteRateLimit_Type)(0),         // 2: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Type
	(PolicySpec_LocalRateLimit_Type)(0),          // 3: agentgateway.dev.resource.PolicySpec.LocalRateLimit.Type
	(PolicySpec_Ai_BuiltinRegexRule)(0),          // 4: agentgateway.dev.resource.PolicySpec.Ai.BuiltinRegexRule
	(PolicySpec_Ai_ActionKind)(0),                // 5: agentgateway.dev.resource.PolicySpec.Ai.ActionKind
	(PolicySpec_ExternalAuth_FailureMode)(0),     // 6: agentgateway.dev.resource.PolicySpec.ExternalAuth.FailureMode
	(PolicySpec_InferenceRouting_FailureMode)(0), // 7: agentgateway.dev.resource.PolicySpec.InferenceRouting.FailureMode
	(PolicySpec_JWT_Mode)(0),                     // 8: agentgateway.dev.resource.PolicySpec.JWT.Mode
	(PolicySpec_ExtProc_FailureMode)(0),          // 9: agentgateway.dev.resource.PolicySpec.ExtProc.FailureMode
	...
	(*PolicySpec_MCPAuth)(nil),                                  // 73: agentgateway.dev.resource.PolicySpec.MCPAuth
	(*PolicySpec_ResourceMetadata)(nil),                         // 74: agentgateway.dev.resource.PolicySpec.ResourceMetadata
	(*PolicySpec_RemoteRateLimit_Descriptor)(nil),               // 75: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor
	(*PolicySpec_RemoteRateLimit_Entry)(nil),                    // 76: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Entry
	(*PolicySpec_Ai_Message)(nil),                               // 77: agentgateway.dev.resource.PolicySpec.Ai.Message
	(*PolicySpec_Ai_PromptEnrichment)(nil),                      // 78: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	(*PolicySpec_Ai_NamedRegex)(nil),                            // 79: agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	(*PolicySpec_Ai_RegexRule)(nil),                             // 80: agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	(*PolicySpec_Ai_Action)(nil),                                // 81: agentgateway.dev.resource.PolicySpec.Ai.Action
	(*PolicySpec_Ai_RegexRules)(nil),                            // 82: agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	(*PolicySpec_Ai_Webhook)(nil),                               // 83: agentgateway.dev.resource.PolicySpec.Ai.Webhook
	(*PolicySpec_Ai_Moderation)(nil),                            // 84: agentgateway.dev.resource.PolicySpec.Ai.Moderation
	(*PolicySpec_Ai_RequestRejection)(nil),                      // 85: agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	(*PolicySpec_Ai_ResponseGuard)(nil),                         // 86: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	(*PolicySpec_Ai_RequestGuard)(nil),                          // 87: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	(*PolicySpec_Ai_PromptGuard)(nil),                           // 88: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	nil,                                                         // 89: agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	nil,                                                         // 90: agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	nil,                                                         // 91: agentgateway.dev.resource.PolicySpec.Ai.ModelAliasesEntry
	(*PolicySpec_ExternalAuth_BodyOptions)(nil),                 // 92: agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	nil, // 93: agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	(*PolicySpec_TransformationPolicy_Transform)(nil), // 94: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	nil,                             // 95: agentgateway.dev.resource.PolicySpec.ResourceMetadata.ExtraEntry
	(*AIBackend_HostOverride)(nil),  // 96: agentgateway.dev.resource.AIBackend.HostOverride
	(*AIBackend_OpenAI)(nil),        // 97: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),        // 98: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),        // 99: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),     // 100: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),       // 101: agentgateway.dev.resource.AIBackend.Bedrock
	...
	(*wrappers.UInt32Value)(nil),    // 106: google.protobuf.UInt32Value
	(*wrappers.BytesValue)(nil),     // 107: google.protobuf.BytesValue
	(*wrappers.BoolValue)(nil),      // 108: google.protobuf.BoolValue
	(*wrappers.StringValue)(nil),    // 109: google.protobuf.StringValue
...
var file_resource_proto_depIdxs = []int32{
	...
	105, // 14: agentgateway.dev.resource.TrafficPolicy.backend_request_timeout:type_name -> google.protobuf.Duration
	105, // 15: agentgateway.dev.resource.TrafficPolicy.request_timeout:type_name -> google.protobuf.Duration
	21,  // 16: agentgateway.dev.resource.TrafficPolicy.retry:type_name -> agentgateway.dev.resource.Retry
	105, // 17: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	...
	105, // 42: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	...
	73,  // 62: agentgateway.dev.resource.PolicySpec.mcp_authentication:type_name -> agentgateway.dev.resource.PolicySpec.MCPAuth
	...
	103, // 68: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	...
	75,  // 74: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.descriptors:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor
	57,  // 75: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.target:type_name -> agentgateway.dev.resource.BackendReference
	105, // 76: agentgateway.dev.resource.PolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	3,   // 77: agentgateway.dev.resource.PolicySpec.LocalRateLimit.type:type_name -> agentgateway.dev.resource.PolicySpec.LocalRateLimit.Type
	88,  // 78: agentgateway.dev.resource.PolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptGuard
	89,  // 79: agentgateway.dev.resource.PolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.PolicySpec.Ai.DefaultsEntry
	90,  // 80: agentgateway.dev.resource.PolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.PolicySpec.Ai.OverridesEntry
	78,  // 81: agentgateway.dev.resource.PolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment
	91,  // 82: agentgateway.dev.resource.PolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ModelAliasesEntry
	57,  // 83: agentgateway.dev.resource.PolicySpec.ExternalAuth.target:type_name -> agentgateway.dev.resource.BackendReference
	93,  // 84: agentgateway.dev.resource.PolicySpec.ExternalAuth.context:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.ContextEntry
	6,   // 85: agentgateway.dev.resource.PolicySpec.ExternalAuth.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.FailureMode
	92,  // 86: agentgateway.dev.resource.PolicySpec.ExternalAuth.include_request_body:type_name -> agentgateway.dev.resource.PolicySpec.ExternalAuth.BodyOptions
	105, // 87: agentgateway.dev.resource.PolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	106, // 88: agentgateway.dev.resource.PolicySpec.ExternalAuth.status_on_error:type_name -> google.protobuf.UInt32Value
	...
	7,   // 90: agentgateway.dev.resource.PolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.InferenceRouting.FailureMode
	107, // 91: agentgateway.dev.resource.PolicySpec.BackendTLS.cert:type_name -> google.protobuf.BytesValue
	107, // 92: agentgateway.dev.resource.PolicySpec.BackendTLS.key:type_name -> google.protobuf.BytesValue
	107, // 93: agentgateway.dev.resource.PolicySpec.BackendTLS.root:type_name -> google.protobuf.BytesValue
	108, // 94: agentgateway.dev.resource.PolicySpec.BackendTLS.insecure:type_name -> google.protobuf.BoolValue
	109, // 95: agentgateway.dev.resource.PolicySpec.BackendTLS.hostname:type_name -> google.protobuf.StringValue
	8,   // 96: agentgateway.dev.resource.PolicySpec.JWT.mode:type_name -> agentgateway.dev.resource.PolicySpec.JWT.Mode
	94,  // 97: agentgateway.dev.resource.PolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	94,  // 98: agentgateway.dev.resource.PolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform
	57,  // 99: agentgateway.dev.resource.PolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	9,   // 100: agentgateway.dev.resource.PolicySpec.ExtProc.failure_mode:type_name -> agentgateway.dev.resource.PolicySpec.ExtProc.FailureMode
	1,   // 101: agentgateway.dev.resource.PolicySpec.MCPAuth.provider:type_name -> agentgateway.dev.resource.PolicySpec.McpIDP
	74,  // 102: agentgateway.dev.resource.PolicySpec.MCPAuth.resource_metadata:type_name -> agentgateway.dev.resource.PolicySpec.ResourceMetadata
	95,  // 103: agentgateway.dev.resource.PolicySpec.ResourceMetadata.extra:type_name -> agentgateway.dev.resource.PolicySpec.ResourceMetadata.ExtraEntry
	76,  // 104: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Entry
	2,   // 105: agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.PolicySpec.RemoteRateLimit.Type
	77,  // 106: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	77,  // 107: agentgateway.dev.resource.PolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Message
	4,   // 108: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.PolicySpec.Ai.BuiltinRegexRule
	79,  // 109: agentgateway.dev.resource.PolicySpec.Ai.RegexRule.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.NamedRegex
	5,   // 110: agentgateway.dev.resource.PolicySpec.Ai.Action.kind:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ActionKind
	85,  // 111: agentgateway.dev.resource.PolicySpec.Ai.Action.reject_response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	81,  // 112: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Action
	80,  // 113: agentgateway.dev.resource.PolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRule
	39,  // 114: agentgateway.dev.resource.PolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	109, // 115: agentgateway.dev.resource.PolicySpec.Ai.Moderation.model:type_name -> google.protobuf.StringValue
	22,  // 116: agentgateway.dev.resource.PolicySpec.Ai.Moderation.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	82,  // 117: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	83,  // 118: agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	85,  // 119: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestRejection
	82,  // 120: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RegexRules
	83,  // 121: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Webhook
	84,  // 122: agentgateway.dev.resource.PolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.PolicySpec.Ai.Moderation
	87,  // 123: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.PolicySpec.Ai.RequestGuard
	86,  // 124: agentgateway.dev.resource.PolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.PolicySpec.Ai.ResponseGuard
	69,  // 125: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	69,  // 126: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.PolicySpec.HeaderTransformation
	70,  // 127: agentgateway.dev.resource.PolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.PolicySpec.BodyTransformation
	110, // 128: agentgateway.dev.resource.PolicySpec.ResourceMetadata.ExtraEntry.value:type_name -> google.protobuf.Value
	109, // 129: agentgateway.dev.resource.AIBackend.OpenAI.model:type_name -> google.protobuf.StringValue
	109, // 130: agentgateway.dev.resource.AIBackend.Gemini.model:type_name -> google.protobuf.StringValue
	109, // 131: agentgateway.dev.resource.AIBackend.Vertex.model:type_name -> google.protobuf.StringValue
	109, // 132: agentgateway.dev.resource.AIBackend.Anthropic.model:type_name -> google.protobuf.StringValue
	109, // 133: agentgateway.dev.resource.AIBackend.Bedrock.model:type_name -> google.protobuf.StringValue
	109, // 134: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_identifier:type_name -> google.protobuf.StringValue
	109, // 135: agentgateway.dev.resource.AIBackend.Bedrock.guardrail_version:type_name -> google.protobuf.StringValue
	96,  // 136: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	109, // 137: agentgateway.dev.resource.AIBackend.Provider.path_override:type_name -> google.protobuf.StringValue
	97,  // 138: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	98,  // 139: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	99,  // 140: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	100, // 141: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	101, // 142: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	104, // 143: agentgateway.dev.resource.AIBackend.Provider.routes:type_name -> agentgateway.dev.resource.AIBackend.Provider.RoutesEntry
	102, // 144: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
	10,  // 145: agentgateway.dev.resource.AIBackend.Provider.RoutesEntry.value:type_name -> agentgateway.dev.resource.AIBackend.RouteType
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[36].OneofWrappers = []any{
		...
		(*PolicySpec_McpAuthentication)(nil),
	}
