...
func (NetworkMode) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[1].Descriptor()
}

func (NetworkMode) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[1]
}
...
func (WorkloadStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[2].Descriptor()
}

func (WorkloadStatus) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[2]
}
...
func (WorkloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[3].Descriptor()
}

func (WorkloadType) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[3]
}
...
func (AppProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[4].Descriptor()
}

func (AppProtocol) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[4]
}
...
func (TunnelProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[5].Descriptor()
}

func (TunnelProtocol) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[5]
}
...
func (LoadBalancing_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[6].Descriptor()
}

func (LoadBalancing_Scope) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[6]
}
...
func (LoadBalancing_Scope) EnumDescriptor() ([]byte, []int) {
	return file_workload_proto_rawDescGZIP(), []int{2, 0}
}
...
func (LoadBalancing_Mode) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[7].Descriptor()
}

func (LoadBalancing_Mode) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[7]
}
...
func (LoadBalancing_Mode) EnumDescriptor() ([]byte, []int) {
	return file_workload_proto_rawDescGZIP(), []int{2, 1}
}
...
func (LoadBalancing_HealthPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[8].Descriptor()
}

func (LoadBalancing_HealthPolicy) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[8]
}
...
func (LoadBalancing_HealthPolicy) EnumDescriptor() ([]byte, []int) {
	return file_workload_proto_rawDescGZIP(), []int{2, 2}
}
...
func (ApplicationTunnel_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_workload_proto_enumTypes[9].Descriptor()
}

func (ApplicationTunnel_Protocol) Type() protoreflect.EnumType {
	return &file_workload_proto_enumTypes[9]
}
...
func (ApplicationTunnel_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_workload_proto_rawDescGZIP(), []int{7, 0}
}
...
type Service struct {
	...
	IpFamilies IPFamilies `protobuf:"varint,9,opt,name=ip_families,json=ipFamilies,proto3,enum=agentgateway.dev.workload.IPFamilies" json:"ip_families,omitempty"`
...
type LoadBalancing struct {
	...
	RoutingPreference []LoadBalancing_Scope `protobuf:"varint,1,rep,packed,name=routing_preference,json=routingPreference,proto3,enum=agentgateway.dev.workload.LoadBalancing_Scope" json:"routing_preference,omitempty"`
	// mode defines how we should handle the routing preferences.
	Mode LoadBalancing_Mode `protobuf:"varint,2,opt,name=mode,proto3,enum=agentgateway.dev.workload.LoadBalancing_Mode" json:"mode,omitempty"`
	// health_policy defines how we should filter endpoints
	HealthPolicy LoadBalancing_HealthPolicy `protobuf:"varint,3,opt,name=health_policy,json=healthPolicy,proto3,enum=agentgateway.dev.workload.LoadBalancing_HealthPolicy" json:"health_policy,omitempty"`
}
...
type Workload struct {
	...
	TunnelProtocol TunnelProtocol `protobuf:"varint,5,opt,name=tunnel_protocol,json=tunnelProtocol,proto3,enum=agentgateway.dev.workload.TunnelProtocol" json:"tunnel_protocol,omitempty"`
	...
	WorkloadType WorkloadType `protobuf:"varint,12,opt,name=workload_type,json=workloadType,proto3,enum=agentgateway.dev.workload.WorkloadType" json:"workload_type,omitempty"`
	...
	Status                WorkloadStatus `protobuf:"varint,17,opt,name=status,proto3,enum=agentgateway.dev.workload.WorkloadStatus" json:"status,omitempty"`
	...
	NetworkMode NetworkMode `protobuf:"varint,25,opt,name=network_mode,json=networkMode,proto3,enum=agentgateway.dev.workload.NetworkMode" json:"network_mode,omitempty"`
	// Extension provides a mechanism to attach arbitrary additional configuration to an object.
...
type Port struct {
	...
	AppProtocol AppProtocol `protobuf:"varint,3,opt,name=app_protocol,json=appProtocol,proto3,enum=agentgateway.dev.workload.AppProtocol" json:"app_protocol,omitempty"`
}
...
type ApplicationTunnel struct {
	...
	Protocol ApplicationTunnel_Protocol `protobuf:"varint,1,opt,name=protocol,proto3,enum=agentgateway.dev.workload.ApplicationTunnel_Protocol" json:"protocol,omitempty"`
...
var file_workload_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x47, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x77, 0x6f,
	...
	0x12, 0x35, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1f, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x64,
	0x65, 0x76, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x50, 0x6f, 0x72, 0x74,
	0x52, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x75, 0x62, 0x6a, 0x65,
	...
	,
	...
	0x49, 0x4c, 0x4f, 0x56, 0x45, 0x52, 0x10, 0x02, 0x22, 0x2f, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x6c,
	0x74, 0x68, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x10, 0x0a, 0x0c, 0x4f, 0x4e, 0x4c, 0x59,
	0x5f, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x41, 0x4c,
	0x4c, 0x4f, 0x57, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x01, 0x22, 0x98, 0x0b, 0x0a, 0x08, 0x57, 0x6f,
	0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x14, 0x20,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x54, 0x75, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x4d, 0x0a, 0x08, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x18, 0x16, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x77, 0x6f,
	...
	0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0x41,
	0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29,
	0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x64, 0x65,
	0x76, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x6c,
	...
	,
	...
	0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x64, 0x65,
	0x76, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x4a, 0x04,
	0x08, 0x0f, 0x10, 0x10, 0x22, 0x50, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x69, 0x74, 0x79,
	...
	0x75, 0x62, 0x7a, 0x6f, 0x6e, 0x65, 0x22, 0x41, 0x0a, 0x08, 0x50, 0x6f, 0x72, 0x74, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x35, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1f, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x2e, 0x64, 0x65, 0x76, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x50, 0x6f,
	0x72, 0x74, 0x52, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x22, 0x95, 0x01, 0x0a, 0x04, 0x50, 0x6f,
	...
	,
	...
	0x45, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x29, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e,
	0x64, 0x65, 0x76, 0x2e, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x4e, 0x65, 0x74,
	...
	,
...
var file_workload_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_workload_proto_goTypes = []interface{}{
	(IPFamilies)(0),                 // 0: agentgateway.dev.workload.IPFamilies
	(NetworkMode)(0),                // 1: agentgateway.dev.workload.NetworkMode
	(WorkloadStatus)(0),             // 2: agentgateway.dev.workload.WorkloadStatus
	(WorkloadType)(0),               // 3: agentgateway.dev.workload.WorkloadType
	(AppProtocol)(0),                // 4: agentgateway.dev.workload.AppProtocol
	(TunnelProtocol)(0),             // 5: agentgateway.dev.workload.TunnelProtocol
	(LoadBalancing_Scope)(0),        // 6: agentgateway.dev.workload.LoadBalancing.Scope
	(LoadBalancing_Mode)(0),         // 7: agentgateway.dev.workload.LoadBalancing.Mode
	(LoadBalancing_HealthPolicy)(0), // 8: agentgateway.dev.workload.LoadBalancing.HealthPolicy
	(ApplicationTunnel_Protocol)(0), // 9: agentgateway.dev.workload.ApplicationTunnel.Protocol
	(*Address)(nil),                 // 10: agentgateway.dev.workload.Address
	(*Service)(nil),                 // 11: agentgateway.dev.workload.Service
	(*LoadBalancing)(nil),           // 12: agentgateway.dev.workload.LoadBalancing
	(*Workload)(nil),                // 13: agentgateway.dev.workload.Workload
	(*Locality)(nil),                // 14: agentgateway.dev.workload.Locality
	(*PortList)(nil),                // 15: agentgateway.dev.workload.PortList
	(*Port)(nil),                    // 16: agentgateway.dev.workload.Port
	(*ApplicationTunnel)(nil),       // 17: agentgateway.dev.workload.ApplicationTunnel
	(*GatewayAddress)(nil),          // 18: agentgateway.dev.workload.GatewayAddress
	(*NetworkAddress)(nil),          // 19: agentgateway.dev.workload.NetworkAddress
...
var file_workload_proto_depIdxs = []int32{
	...
	11, // 1: agentgateway.dev.workload.Address.service:type_name -> agentgateway.dev.workload.Service
	19, // 2: agentgateway.dev.workload.Service.addresses:type_name -> agentgateway.dev.workload.NetworkAddress
	16, // 3: agentgateway.dev.workload.Service.ports:type_name -> agentgateway.dev.workload.Port
	18, // 4: agentgateway.dev.workload.Service.waypoint:type_name -> agentgateway.dev.workload.GatewayAddress
	12, // 5: agentgateway.dev.workload.Service.load_balancing:type_name -> agentgateway.dev.workload.LoadBalancing
	0,  // 6: agentgateway.dev.workload.Service.ip_families:type_name -> agentgateway.dev.workload.IPFamilies
	21, // 7: agentgateway.dev.workload.Service.extensions:type_name -> agentgateway.dev.workload.Extension
	6,  // 8: agentgateway.dev.workload.LoadBalancing.routing_preference:type_name -> agentgateway.dev.workload.LoadBalancing.Scope
	7,  // 9: agentgateway.dev.workload.LoadBalancing.mode:type_name -> agentgateway.dev.workload.LoadBalancing.Mode
	8,  // 10: agentgateway.dev.workload.LoadBalancing.health_policy:type_name -> agentgateway.dev.workload.LoadBalancing.HealthPolicy
	5,  // 11: agentgateway.dev.workload.Workload.tunnel_protocol:type_name -> agentgateway.dev.workload.TunnelProtocol
	18, // 12: agentgateway.dev.workload.Workload.waypoint:type_name -> agentgateway.dev.workload.GatewayAddress
	18, // 13: agentgateway.dev.workload.Workload.network_gateway:type_name -> agentgateway.dev.workload.GatewayAddress
	3,  // 14: agentgateway.dev.workload.Workload.workload_type:type_name -> agentgateway.dev.workload.WorkloadType
	17, // 15: agentgateway.dev.workload.Workload.application_tunnel:type_name -> agentgateway.dev.workload.ApplicationTunnel
	22, // 16: agentgateway.dev.workload.Workload.services:type_name -> agentgateway.dev.workload.Workload.ServicesEntry
	2,  // 17: agentgateway.dev.workload.Workload.status:type_name -> agentgateway.dev.workload.WorkloadStatus
	14, // 18: agentgateway.dev.workload.Workload.locality:type_name -> agentgateway.dev.workload.Locality
	1,  // 19: agentgateway.dev.workload.Workload.network_mode:type_name -> agentgateway.dev.workload.NetworkMode
	21, // 20: agentgateway.dev.workload.Workload.extensions:type_name -> agentgateway.dev.workload.Extension
	23, // 21: agentgateway.dev.workload.Workload.capacity:type_name -> google.protobuf.UInt32Value
	16, // 22: agentgateway.dev.workload.PortList.ports:type_name -> agentgateway.dev.workload.Port
	4,  // 23: agentgateway.dev.workload.Port.app_protocol:type_name -> agentgateway.dev.workload.AppProtocol
	9,  // 24: agentgateway.dev.workload.ApplicationTunnel.protocol:type_name -> agentgateway.dev.workload.ApplicationTunnel.Protocol
	20, // 25: agentgateway.dev.workload.GatewayAddress.hostname:type_name -> agentgateway.dev.workload.NamespacedHostname
	19, // 26: agentgateway.dev.workload.GatewayAddress.address:type_name -> agentgateway.dev.workload.NetworkAddress
	24, // 27: agentgateway.dev.workload.Extension.config:type_name -> google.protobuf.Any
	15, // 28: agentgateway.dev.workload.Workload.ServicesEntry.value:type_name -> agentgateway.dev.workload.PortList
...
func file_workload_proto_init() {
	...
	file_workload_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Address_Workload)(nil),
		(*Address_Service)(nil),
	}
	file_workload_proto_msgTypes[8].OneofWrappers = []interface{}{
