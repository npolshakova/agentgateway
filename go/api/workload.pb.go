...
const file_workload_proto_rawDesc = "" +
	"\n" +
	"\x0eworkload.proto\x12\x19agentgateway.dev.workload\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x19google/protobuf/any.proto\"\x94\x01\n" +
	"\aAddress\x12A\n" +
	"\bworkload\x18\x01 \x01(\v2#.agentgateway.dev.workload.WorkloadH\x00R\bworkload\x12>\n" +
	"\aservice\x18\x02 \x01(\v2\".agentgateway.dev.workload.ServiceH\x00R\aserviceB\x06\n" +
	"\x04type\"\xa9\x04\n" +
	"\aService\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12\x1a\n" +
	"\bhostname\x18\x03 \x01(\tR\bhostname\x12G\n" +
	"\taddresses\x18\x04 \x03(\v2).agentgateway.dev.workload.NetworkAddressR\taddresses\x125\n" +
	"\x05ports\x18\x05 \x03(\v2\x1f.agentgateway.dev.workload.PortR\x05ports\x12*\n" +
	"\x11subject_alt_names\x18\x06 \x03(\tR\x0fsubjectAltNames\x12E\n" +
	"\bwaypoint\x18\a \x01(\v2).agentgateway.dev.workload.GatewayAddressR\bwaypoint\x12O\n" +
	"\x0eload_balancing\x18\b \x01(\v2(.agentgateway.dev.workload.LoadBalancingR\rloadBalancing\x12F\n" +
	"\vip_families\x18\t \x01(\x0e2%.agentgateway.dev.workload.IPFamiliesR\n" +
	"ipFamilies\x12D\n" +
	"\n" +
	"extensions\x18\n" +
	" \x03(\v2$.agentgateway.dev.workload.ExtensionR\n" +
	"extensions\"\xdd\x03\n" +
	"\rLoadBalancing\x12]\n" +
	"\x12routing_preference\x18\x01 \x03(\x0e2..agentgateway.dev.workload.LoadBalancing.ScopeR\x11routingPreference\x12A\n" +
	"\x04mode\x18\x02 \x01(\x0e2-.agentgateway.dev.workload.LoadBalancing.ModeR\x04mode\x12Z\n" +
	"\rhealth_policy\x18\x03 \x01(\x0e25.agentgateway.dev.workload.LoadBalancing.HealthPolicyR\fhealthPolicy\"e\n" +
	"\x05Scope\x12\x15\n" +
	...
	"\anetwork\x18\x04 \x01(\tR\anetwork\x12R\n" +
	"\x0ftunnel_protocol\x18\x05 \x01(\x0e2).agentgateway.dev.workload.TunnelProtocolR\x0etunnelProtocol\x12!\n" +
	"\ftrust_domain\x18\x06 \x01(\tR\vtrustDomain\x12'\n" +
	"\x0fservice_account\x18\a \x01(\tR\x0eserviceAccount\x12E\n" +
	"\bwaypoint\x18\b \x01(\v2).agentgateway.dev.workload.GatewayAddressR\bwaypoint\x12R\n" +
	"\x0fnetwork_gateway\x18\x13 \x01(\v2).agentgateway.dev.workload.GatewayAddressR\x0enetworkGateway\x12\x12\n" +
	"\x04node\x18\t \x01(\tR\x04node\x12%\n" +
	"\x0ecanonical_name\x18\n" +
	" \x01(\tR\rcanonicalName\x12-\n" +
	"\x12canonical_revision\x18\v \x01(\tR\x11canonicalRevision\x12L\n" +
	"\rworkload_type\x18\f \x01(\x0e2'.agentgateway.dev.workload.WorkloadTypeR\fworkloadType\x12#\n" +
	"\rworkload_name\x18\r \x01(\tR\fworkloadName\x12#\n" +
	"\rnative_tunnel\x18\x0e \x01(\bR\fnativeTunnel\x12[\n" +
	"\x12application_tunnel\x18\x17 \x01(\v2,.agentgateway.dev.workload.ApplicationTunnelR\x11applicationTunnel\x12M\n" +
	"\bservices\x18\x16 \x03(\v21.agentgateway.dev.workload.Workload.ServicesEntryR\bservices\x125\n" +
	"\x16authorization_policies\x18\x10 \x03(\tR\x15authorizationPolicies\x12A\n" +
	"\x06status\x18\x11 \x01(\x0e2).agentgateway.dev.workload.WorkloadStatusR\x06status\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x12 \x01(\tR\tclusterId\x12?\n" +
	"\blocality\x18\x18 \x01(\v2#.agentgateway.dev.workload.LocalityR\blocality\x12I\n" +
	"\fnetwork_mode\x18\x19 \x01(\x0e2&.agentgateway.dev.workload.NetworkModeR\vnetworkMode\x12D\n" +
	"\n" +
	"extensions\x18\x1a \x03(\v2$.agentgateway.dev.workload.ExtensionR\n" +
	"extensions\x128\n" +
	"\bcapacity\x18\x1b \x01(\v2\x1c.google.protobuf.UInt32ValueR\bcapacity\x1a`\n" +
	"\rServicesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x129\n" +
	"\x05value\x18\x02 \x01(\v2#.agentgateway.dev.workload.PortListR\x05value:\x028\x01J\x04\b\x0f\x10\x10\"P\n" +
	"\bLocality\x12\x16\n" +
	"\x06region\x18\x01 \x01(\tR\x06region\x12\x12\n" +
	"\x04zone\x18\x02 \x01(\tR\x04zone\x12\x18\n" +
	"\asubzone\x18\x03 \x01(\tR\asubzone\"A\n" +
	"\bPortList\x125\n" +
	"\x05ports\x18\x01 \x03(\v2\x1f.agentgateway.dev.workload.PortR\x05ports\"\x95\x01\n" +
	"\x04Port\x12!\n" +
	"\fservice_port\x18\x01 \x01(\rR\vservicePort\x12\x1f\n" +
	"\vtarget_port\x18\x02 \x01(\rR\n" +
	"targetPort\x12I\n" +
	"\fapp_protocol\x18\x03 \x01(\x0e2&.agentgateway.dev.workload.AppProtocolR\vappProtocol\"\x9b\x01\n" +
	"\x11ApplicationTunnel\x12Q\n" +
	"\bprotocol\x18\x01 \x01(\x0e25.agentgateway.dev.workload.ApplicationTunnel.ProtocolR\bprotocol\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\"\x1f\n" +
	"\bProtocol\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05PROXY\x10\x01\"\xf8\x01\n" +
	"\x0eGatewayAddress\x12K\n" +
	"\bhostname\x18\x01 \x01(\v2-.agentgateway.dev.workload.NamespacedHostnameH\x00R\bhostname\x12E\n" +
	"\aaddress\x18\x02 \x01(\v2).agentgateway.dev.workload.NetworkAddressH\x00R\aaddress\x12&\n" +
	...
	"\x11LEGACY_ISTIO_MTLS\x10\x02B1Z/github.com/agentgateway/agentgateway/go/api;apib\x06proto3"
...
func file_workload_proto_init() {
	...
	file_workload_proto_msgTypes[0].OneofWrappers = []any{
		(*Address_Workload)(nil),
		(*Address_Service)(nil),
	}
	file_workload_proto_msgTypes[8].OneofWrappers = []any{
